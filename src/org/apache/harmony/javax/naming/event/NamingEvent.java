...
package org.apache.harmony.javax.naming.event;
...
public class NamingEvent extends EventObject {
	 ...
	 * @param newBinding
	 *            binding after the event. <code>newBinding</code> might be null
	 *            depending on the value of the <code>type</code> parameter as
	 *            follows:
	 *            <ul>
	 *            <li> <code>OBJECT_ADDED</code> - <code>newBinding</code> cannot
	 *            be null</li>
	 *            <li> <code>OBJECT_CHANGED</code> - <code>newBinding</code>
	 *            cannot be null</li>
	 *            <li> <code>OBJECT_REMOVED</code> - <code>newBinding</code> can
	 *            be null</li>
	 *            <li> <code>OBJECT_RENAMED</code> - <code>newBinding</code> can
	 *            be null</li>
	 *            </ul>
	 *            The names are relative to the <code>eventContext</code>
	 * @param oldBinding
	 *            the binding before the event. <code>oldBinding</code> might be
	 *            null depending on the value of the <code>type</code> parameter
	 *            as follows:
	 *            <ul>
	 *            <li> <code>OBJECT_ADDED</code> - <code>oldBinding</code> can be
	 *            null</li>
	 *            <li> <code>OBJECT_CHANGED</code> - <code>oldBinding</code>
	 *            cannot be null</li>
	 *            <li> <code>OBJECT_REMOVED</code> - <code>oldBinding</code>
	 *            cannot be null</li>
	 *            <li> <code>OBJECT_RENAMED</code> - <code>oldBinding</code> can
	 *            be null</li>
	 *            </ul>
	 *            The names are relative to the <code>eventContext</code>
	 * @param changeInfo
	 ...
	 * was registered using <code>EventContext.addNamingListener</code>. Returns
	 * null otherwise. Therefore for an <code>OBJECT_RENAMED</code> event, the
	 * return value will be non-null if the new name places the binding within
	 * the scope for the listener.
	 * </p>
	 * 
