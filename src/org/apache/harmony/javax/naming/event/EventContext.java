...
public interface EventContext extends Context {
	 ...
	 * </p>
	 * <p>
	 * When the scope is <code>ONELEVEL_SCOPE</code>, <code>name</code> must be
	 * a context. Otherwise <code>name</code> can be a context or a bound
	 * object.
	 * </p>
	 * <p>
	 ...
	 * <code>EventContext</code>. If there are no registrations this method does
	 * nothing.
	 * 
	 * @param namingListener
