...
public final class PagedResultsControl extends BasicControl {
	...
	static ASN1Type ASN1_ENCODER = new ASN1Sequence(new ASN1Type[] {
		...
		public Object getDecodedObject(BerInputStream in) {
			...
			final int size = new BigInteger((byte[]) values[0]).intValue();
			final byte[] cookie = (byte[]) values[1];
			return new PagedResultSearchControlValue(size, cookie);
		}

		@Override
		public void getValues(Object object, Object values[]) {
			final PagedResultSearchControlValue pg = (PagedResultSearchControlValue) object;
	...
	public PagedResultsControl(int pageSize, boolean criticality)
		...
		value = ASN1_ENCODER.encode(new PagedResultSearchControlValue(pageSize,
				"".getBytes())); //$NON-NLS-1$
	}
