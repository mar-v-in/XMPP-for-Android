...
public class InitialLdapContext extends InitialDirContext implements
	...
	/**
	 * Constructs an <code>InitialLdapContext</code> instance without using any
	 * environment properties or connection controls.
	 * 
	...
	public InitialLdapContext(Hashtable<?, ?> h, Control[] cs)
		...
		if (null != cs) {
			final Control[] cloneOfCs = new Control[cs.length];
