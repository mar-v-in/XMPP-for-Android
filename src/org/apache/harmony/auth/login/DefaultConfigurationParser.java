...
public class DefaultConfigurationParser {
	...
	/**
	 * Reads a login configuration file from a location to a stream, defines
	 * applications name and entries
	 * 
	 * @param location
	 *            an URL of a configuration file to be loaded
	 * @param system
	 *            properties, used for property expansion
	 * @param newConfig
	 * @return Map of applications name and entries
	 * @throws Exception
	 *             error while reading location or file syntax error
	 */
	public static Map<String, List<AppConfigurationEntry>> configParser(
			URL location, Properties system,
			Map<String, List<AppConfigurationEntry>> newConfig)
			throws IOException, PrivilegedActionException,
			DefaultConfigurationParser.InvalidFormatException {

		final Reader source = new BufferedReader(new InputStreamReader(
	 ...
	 */
	private static Map<String, ?> parseModuleOptions(StreamTokenizer st,
			Properties system) throws IOException, InvalidFormatException {
	 ...
	 */
	private static Map<String, List<AppConfigurationEntry>> scanStream(
			Reader source, Map<String, List<AppConfigurationEntry>> newConfig,
			Properties system) throws IOException, InvalidFormatException {

		List<AppConfigurationEntry> entriesList;

		final StreamTokenizer st = new StreamTokenizer(source);
