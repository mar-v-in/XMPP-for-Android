...
public abstract class GenericURLContextFactory implements ObjectFactory {
	 ...
	 * specification.
	 * 
	 * If <code>obj</code> is <code>null</code>, just creates and returns an
	 * underlying context.
	 * 
	 * If <code>obj</code> is a proper URL string, lookups and returns an object
	 * specified by that string.
	 * 
	...
	public Object getObjectInstance(Object obj, Name name, Context nameCtx,
		...
		final Context context = createURLContext(environment);
			...
			if (obj instanceof String[]) {
				...
				if (strings.length < 1) {
					...
					throw new ConfigurationException(
							Messages.getString("jndi.2C")); //$NON-NLS-1$
				}
