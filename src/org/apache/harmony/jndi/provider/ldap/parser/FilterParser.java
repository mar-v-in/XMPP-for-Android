...
public class FilterParser implements FilterParserConstants {
	...
	static private final class LookaheadSuccess extends java.lang.Error {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4435009373861012329L;
	}

	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0xc080c, 0xc080c, 0x40800, 0x40800, 0x40800,
				0x100000, 0x4084c, 0x4c, 0xc084c, 0xc080c, 0xc084c, 0x400000,
				0x3000000, 0x3000000, 0x3000000, 0x10, 0x3000001, 0xac184c,
				0xac184c, 0x40804, 0x40804, 0x10, 0x10, 0x174e, 0xae184c,
				0xc000, 0x1002, 0x104e, 0xac184c, 0x20000, 0xac184c, };
	}

	public static void main(String args[]) throws ParseException,
			FileNotFoundException {
		final FilterParser parser = new FilterParser(new FileInputStream(
				"parser.filter.test"));
	...
	final public void asterisk_start(List<String> list) throws ParseException {
	...
	final public String backslashValue() throws ParseException {
		...
		value = hexDigit();
		return convertToUtf8Char(value);
	}
	...
	private String convertToUtf8Char(String s) {
		final byte[] bs = new byte[] { (byte) Integer.parseInt(s, 16) };
	...
	final public MatchingRuleAssertion extensible_1(String type)
			throws ParseException {
		final MatchingRuleAssertion rule = new MatchingRuleAssertion();
		rule.setType(type);
		String value;
		if (jj_2_5(2)) {
	...
	public ParseException generateParseException() {
		jj_expentries.clear();
		final boolean[] la1tokens = new boolean[26];
		if (jj_kind >= 0) {
	...
	final public Filter item() throws ParseException {
		...
		case LBRACE:
			...
			if (jj_2_2(2)) {
				...
				filter.setValue(new AttributeTypeAndValuePair(des, value));
			} else {
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				case GREATER:
	...
	private void jj_add_error_token(int kind, int pos) {
		...
		if (pos == jj_endpos + 1) {
			...
			jj_entries_loop: for (final java.util.Iterator<int[]> it = jj_expentries
					.iterator(); it.hasNext();) {
				final int[] oldentry = (it.next());
	...
	private Filter parseSubstring(String des, List<String> list) {
		Filter filter = null;
		if (list.size() == 1) {
			if (list.get(0).equals("*")) {
				...
				filter.setValue(new AttributeTypeAndValuePair(des, list.get(0)));
			}
		} else {
			String initial = null;
			String any = "";
			...
			final SubstringFilter substring = new SubstringFilter(des);
			if (initial != null) {
	...
	final public void test() throws ParseException {
		...
		case LPARENT:
			/*
			 * initial args for test, so there should not be args index larger
			 * than 49 in test case
			 */
			args = new Object[20];
	...
	final public void value_start(List<String> list) throws ParseException {
		String value;
		value = value();
		list.add(value);
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
