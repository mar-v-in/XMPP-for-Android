...
public class SchemaParser {
	...
	public static String getName(String schemaLine) {
		final StringTokenizer st = new StringTokenizer(schemaLine);
		st.nextToken();
	...
	public static Hashtable<String, Object> parseValue(String schemaLine) {
		...
		final Hashtable<String, Object> schemaDef = new Hashtable<String, Object>();
		...
		while (st.hasMoreTokens()) {
			...
			final String attrName = st.nextToken().toUpperCase();
