...
public class Utils {
	...
	/**
	 * Convert <code>obj</code> to <code>char[]</code>. If obj is byte[], then
	 * using UTF-8 charset. when <code>obj</code> is <code>null</code>, zero
	 * length char array would be returned.
	 * 
	 * @param obj
	 *            object to be covert
	 * @return UTF-8 char[]
	...
	/**
	 * Convert <code>obj</code> to <code>String</code>. If obj is byte[], then
	 * using UTF-8 charset. when <code>obj</code> is <code>null</code>, empty
