	...
	public static final ASN1Type LDAPMessage = new ASN1SequenceWrap(
			new ASN1Type[] {
					...
					new ASN1ChoiceWrap(new ASN1Type[] { BindRequest,
							BindResponse, UnbindRequest, SearchRequest,
							SearchResultEntry, SearchResultDone,
							SearchResultReference, ModifyRequest,
							ModifyResponse, AddRequest, AddResponse,
							DelRequest, DelResponse, ModifyDNRequest,
							ModifyDNResponse, CompareRequest, CompareResponse,
							AbandonRequest, ExtendedRequest, ExtendedResponse }),
					new ASN1Implicit(ASN1Constants.CLASS_CONTEXTSPECIFIC, 0,
