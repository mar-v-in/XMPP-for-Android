...
/**
 * This interface is responsible for encoding data according to ASN.1 type
 * schema. Below is type mapping between ASN.1 and Java.
 * <p>
...
public interface ASN1Encodable {
	...
	/**
	 * Encodes data into <code>values</code>. It is caller's responsibility to
	 * create <code>values</code> array, and the size of <code>values</code> is
	 * defined by the ASN.1 type schema which is to be encoded. Classes realize
	 * this interface need to fill encoded value into the <code>values</code>
	 * array.
	 * 
	 * @param values
	 */
