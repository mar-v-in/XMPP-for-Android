...
import org.apache.harmony.javax.naming.AuthenticationException;
...
import org.apache.harmony.javax.naming.ContextNotEmptyException;
...
import org.apache.harmony.javax.naming.directory.AttributeInUseException;
import org.apache.harmony.javax.naming.directory.InvalidAttributeIdentifierException;
import org.apache.harmony.javax.naming.directory.InvalidAttributeValueException;
...
public class LdapUtils {
	...
	public static LdapName convertToRelativeName(LdapName dn, LdapName base)
		...
		final Name prefix = dn.getPrefix(base.size());
	...
	public static NamingException getExceptionFromResult(LdapResult result) {
		final int errorCode = result.getResultCode();
		// 0 means successful
		if (errorCode == 0) {
			return null;
		}
	...
	public static SocketFactory getSocketFactory(Hashtable<?, ?> envmt,
		...
		final String factoryName = (String) envmt
	...
	public static Filter parseFilter(String filter, Object[] args)
		...
		final FilterParser parser = new FilterParser(filter);
	...
	public static LdapUrlParser parserURL(String url, boolean isAllowedQuery)
		...
		final LdapUrlParser parser = new LdapUrlParser(url);
		try {
			parser.parseURL();
		} catch (final ParseException e) {
			// ldap.2C=Invalid LDAP URL
			final IllegalArgumentException ex = new IllegalArgumentException(
					Messages.getString("ldap.2C")); //$NON-NLS-1$
			ex.initCause(e);
			throw ex;
		}
