...
public class ECNotificationControl extends BasicControl implements
	...
	private void decodeContend() {
		try {
			final Object[] values = (Object[]) LdapASN1Constant.EntryChangeNotificationControl
					.decode(value);
			decodeValues(values);
	...
	/**
	 * get enumerated change type value defined in {@link http
	 * ://www3.ietf.org/proceedings/01mar/I-D/ldapext-psearch-03.txt}
	 * 
