...
public class LdapMessage implements ASN1Encodable, ASN1Decodable {
	...
	/**
	 * Construct a response message. <code>op</code> indicate which operation to
	 * be used, and the message would be initialized after calling
	 * <code>decode(byte[])</code> or <code>decode(InputStream)</code> method.
	 * 
	 * @param op
	...
	/**
	 * Construct a request message. <code>op</code> may not be <code>null</code>
	 * . <code>controls</code> is <code>null</code> or a array of zero length
	 * means there is no control for this message.
	 * 
	 * @param opIndex
	...
	public void decode(InputStream in) throws IOException {
		final Object[] values = (Object[]) LdapASN1Constant.LDAPMessage
				.decode(in);
		decodeValues(values);
	}
	...
	public void decodeValues(Object[] values) {
		...
		final ChosenValue chosen = (ChosenValue) values[1];
		...
		if (values[2] != null) {
			final Collection<Object[]> list = (Collection<Object[]>) values[2];
			controls = new Control[list.size()];
			int index = 0;
			for (final Object[] objects : list) {
				final LdapControl lcontrol = new LdapControl();
	...
	public void encodeValues(Object[] values) {
		...
		if (controls != null) {
			final List<LdapControl> list = new ArrayList<LdapControl>(
					controls.length);
